...
img_norm_cfg = dict(
    mean=[209.69, 205.145, 211.50], std=[41, 45.44, 39.48], to_rgb=True)
crop_size = (512, 512)
train_pipeline = [
...
work_dir = './work_dirs_HuBMAP/5_fold_alldata/fold2_twins_svt-l_uperhead_8x2_512x512_160k_ade20k_0100_moreaug'
gpu_ids = [0]
auto_resume = False
