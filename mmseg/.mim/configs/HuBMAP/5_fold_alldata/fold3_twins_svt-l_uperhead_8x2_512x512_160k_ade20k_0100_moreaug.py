...
img_norm_cfg = dict(
    mean=[209.57, 204.73, 211.23], std=[40.91, 45.56, 39.58], to_rgb=True)
crop_size = (512, 512)
train_pipeline = [
    ...
    dict(
        type='Normalize',
        mean=[209.57, 204.73, 211.23],
        std=[40.91, 45.56, 39.58],
        to_rgb=True),
...
work_dir = './work_dirs_HuBMAP/5_fold_alldata/fold3_twins_svt-l_uperhead_8x2_512x512_160k_ade20k_0100_moreaug'
gpu_ids = [0]
auto_resume = False
