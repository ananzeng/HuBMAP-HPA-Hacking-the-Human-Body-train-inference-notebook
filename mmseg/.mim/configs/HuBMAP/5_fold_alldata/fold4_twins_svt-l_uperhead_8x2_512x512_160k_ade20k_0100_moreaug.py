...
img_norm_cfg = dict(
    mean=[208.85, 204.42, 210.98], std=[41.47, 45.67, 39.53], to_rgb=True)
crop_size = (512, 512)
train_pipeline = [
    ...
    dict(
        type='Normalize',
        mean=[208.85, 204.42, 210.98],
        std=[41.47, 45.67, 39.53],
        to_rgb=True),
...
work_dir = './work_dirs_HuBMAP/5_fold_alldata/fold4_twins_svt-l_uperhead_8x2_512x512_160k_ade20k_0100_moreaug'
gpu_ids = [0]
auto_resume = False
