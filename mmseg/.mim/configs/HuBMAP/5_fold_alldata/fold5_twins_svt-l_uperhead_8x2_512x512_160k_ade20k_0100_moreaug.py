...
img_norm_cfg = dict(
    mean=[208.58, 204.18, 210.73], std=[41.86, 45.98, 39.86], to_rgb=True)
crop_size = (512, 512)
train_pipeline = [
    ...
    dict(
        type='Normalize',
        mean=[208.58, 204.18, 210.73],
        std=[41.86, 45.98, 39.86],
        to_rgb=True),
...
work_dir = './work_dirs_HuBMAP/5_fold_alldata/fold5_twins_svt-l_uperhead_8x2_512x512_160k_ade20k_0100_moreaug'
gpu_ids = [0]
auto_resume = False
