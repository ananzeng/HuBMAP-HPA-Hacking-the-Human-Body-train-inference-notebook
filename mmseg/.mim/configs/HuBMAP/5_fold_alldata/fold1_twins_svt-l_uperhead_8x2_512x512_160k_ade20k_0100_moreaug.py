...
img_norm_cfg = dict(
    mean=[209.41, 204.892, 211.32], std=[41.21, 45.42, 39.36], to_rgb=True)
crop_size = (512, 512)
train_pipeline = [
    ...
    dict(
        type='Normalize',
        mean=[209.41, 204.892, 211.32],
        std=[41.21, 45.42, 39.36],
        to_rgb=True),
...
work_dir = './work_dirs_HuBMAP/5_fold_alldata/fold1_twins_svt-l_uperhead_8x2_512x512_160k_ade20k_0100_moreaug'
gpu_ids = [0]
auto_resume = False
