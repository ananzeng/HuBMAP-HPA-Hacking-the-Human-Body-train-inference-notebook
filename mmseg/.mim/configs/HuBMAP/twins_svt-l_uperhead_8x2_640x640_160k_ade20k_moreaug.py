...
log_level = 'INFO'
load_from = None
resume_from = './work_dirs_HuBMAP/twins_svt-l_uperhead_8x2_640x640_160k_ade20k_moreaug_smalllr/iter_45000.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs_HuBMAP/twins_svt-l_uperhead_8x2_640x640_160k_ade20k_moreaug_smalllr'
gpu_ids = [0]
auto_resume = False
