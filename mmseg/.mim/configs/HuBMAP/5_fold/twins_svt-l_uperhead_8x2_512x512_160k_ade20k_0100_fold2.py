...
data_root = "HuBMAP_dataset_5fold/HuBMAP_dataset_fold_2"
img_norm_cfg = dict(
    mean=[209.29, 204.83, 211.16], std=[41.47, 45.82, 39.92], to_rgb=True)
crop_size = (512, 512)
train_pipeline = [
    ...
    dict(
        type='Normalize',
        mean=[209.29, 204.83, 211.16],
        std=[41.47, 45.82, 39.92],
        to_rgb=True),
...
log_level = 'INFO'
load_from = None
resume_from = './work_dirs_HuBMAP/5_fold/twins_svt-l_uperhead_8x2_512x512_160k_ade20k_0100_fold_2/iter_30000.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs_HuBMAP/5_fold/twins_svt-l_uperhead_8x2_512x512_160k_ade20k_0100_fold_2'
gpu_ids = [0]
auto_resume = False
