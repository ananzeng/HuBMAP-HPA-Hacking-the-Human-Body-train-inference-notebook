...
data_root = 'HuBMAP_dataset_5fold/HuBMAP_dataset_fold_1'
img_norm_cfg = dict(
    mean=[208.72, 204.29, 210.85], std=[41.67, 45.77, 39.67], to_rgb=True)
crop_size = (512, 512)
train_pipeline = [
    ...
    dict(
        type='Normalize',
        mean=[208.72, 204.29, 210.85],
        std=[41.67, 45.77, 39.67],
        to_rgb=True),
...
log_level = 'INFO'
load_from = None
resume_from = './work_dirs_HuBMAP/5_fold/twins_svt-l_uperhead_8x2_512x512_160k_ade20k_0100_fold_1/iter_30000.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs_HuBMAP/5_fold/twins_svt-l_uperhead_8x2_512x512_160k_ade20k_0100_fold_1'
gpu_ids = [0]
auto_resume = False
