...
dataset_type = 'MulitDataset_tiff'
data_root = 'HuBMAP_dataset_mulit_tiff'
img_norm_cfg = dict(
    mean=[208.75, 204.22, 210.78], std=[41.62, 46.04, 40.07], to_rgb=True)
crop_size = (512, 512)
train_pipeline = [
    ...
    dict(
        type='Normalize',
        mean=[208.75, 204.22, 210.78],
        std=[41.62, 46.04, 40.07],
        to_rgb=True),
...
work_dir = './work_dirs_HuBMAP_mulit/upernet_swin_base_patch4_window12_512x512_160k_ade20k_pretrain_384x384_22K_tiff'
gpu_ids = [0]
auto_resume = False
