...
data = dict(
    ...
    train=dict(
        ...
        split='5fold/splits_3/train.txt'),
    val=dict(
        type='MulitDataset',
        data_root='HuBMAP_dataset_mulit',
        img_dir='images',
...
work_dir = './work_dirs_HuBMAP_mulit_5fold/upernet_swin_base_patch4_window12_512x512_160k_ade20k_pretrain_384x384_22K_fold3'
gpu_ids = [0]
auto_resume = False
